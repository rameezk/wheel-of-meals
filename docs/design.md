...
Every endpoint is rate limited per caller in the Worker - 20 Household creations
a minute, 120 other writes, 300 reads - see ADR-0007. Caps are set now because
